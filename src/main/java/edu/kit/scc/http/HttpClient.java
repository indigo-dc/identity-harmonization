...
public class HttpClient {
	...
	public HttpResponse makeHttpPostRequest(String user, String password, String body, String url) {
		return makeRequest(CustomUrlConnection.getHttpConnection(url), user, password, body, RequestMethod.POST);
	}
	...
	public HttpResponse makeHttpsGetRequest(String user, String password, String url) {
		return makeRequest(CustomUrlConnection.getSecureHttpConnection(false, url), user, password, null,
				RequestMethod.GET);
	}
	...
	public HttpResponse makeHttpsPostRequest(String user, String password, String body, String url) {
		return makeRequest(CustomUrlConnection.getSecureHttpConnection(false, url), user, password, body,
				RequestMethod.POST);
	}
